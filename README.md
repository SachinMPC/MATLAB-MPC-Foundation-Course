...
1. Click on [![Open in MATLAB Online](https://www.mathworks.com/images/responsive/global/open-in-matlab-online.svg)](https://matlab.mathworks.com/open/github/v1?repo=SachinMPC/MATLAB-MPC-Foundation-Course](https://github.com/SachinMPC/MATLAB-MPC-Foundation-Course)). This will allow you to access the content online in your web browser through MATLAB Online.
